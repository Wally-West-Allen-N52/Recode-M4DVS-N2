...
import modelo.regra.negocio.Aluno;
import modelo.regra.negocio.AlunoGraduacao;
import modelo.regra.negocio.AlunoPosGraduacao;
...
public class ControleAluno extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		Aluno aluno; // GENÉRICO
		String tipo = request.getParameter("rdbTipo");
		if (tipo.equals("Grad"))
			aluno = new AlunoGraduacao(); // EXPECIFICO
		else
			aluno = new AlunoPosGraduacao(); // EXPECIFICO
